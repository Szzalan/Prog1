...

{
	...
	Simple_window win {Point{100,100}, xmax, ymax, "Function Graphs"}; //100,100 pontból kezdve, xmax széles, ymax magas,felirat
	Axis x {Axis::x, Point{100, y_cross}, xlength,x_scale, "1==20 pixels"}; // x tengely, 100,300 pontból kezdve,400 széles,20al megszorozzuk a fv(1 egység 20pixel)
	...
	cosine.set_color(Color::cyan);
		...
		win.attach(cosine);
		win.attach(slp_cos); 
		win.wait_for_button(); //gombra várás
